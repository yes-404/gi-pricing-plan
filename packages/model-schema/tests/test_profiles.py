"""Profile shapes (`01` §4.7, FR-65, FR-66)."""
...
def test_exposure_years_refuses_a_float_shaped_value() -> None:
    ...
    pydantic ever sees it (FR-10's rule for the money and exposure path) — so this
...
def test_a_null_level_is_accepted_and_distinct_from_the_string_null() -> None:
    """The authored contract declares `level` as `["string", "null"]` (FR-66): a null
