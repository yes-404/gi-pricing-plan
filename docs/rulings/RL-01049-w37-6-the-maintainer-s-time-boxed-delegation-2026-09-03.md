...
id: RL-1049
family: ruling
title: W37-6 — the maintainer's time-boxed delegation, 2026-09-03
...
was: docs/plans/2026-09-03-w37-6-time-boxed-delegation.md
---
...
**RFC-937 §1/§4 amendments needed to reach a completing, green run** — owner values, scope
...
**The Work close of WK-697 is not delegated.** Do not start W37-7 or any later slice.
...
3. **Write the handover** in the shape of
   [`../plans/PL-00740-w5-worker-handover-at-vm-shutdown.md`](../plans/PL-00740-w5-worker-handover-at-vm-shutdown.md) — final state, the
...
**A handover written and not committed is the failure the WK-661 record exists to prevent.**
Step 3's commit is the step, not the writing.

## 5. Reporting

**Status goes to the `docs/roadmap.md` WK-697 row and to `register-owed.py`, not to chat** —
...
[`../plans/PL-01038-w37-6-handover-at-the-close-of-the-delegated-window-2026-09-03.md`](../plans/PL-01038-w37-6-handover-at-the-close-of-the-delegated-window-2026-09-03.md) is its step 3,
...
closes"* (§ preamble, `docs/rulings/RL-01049-w37-6-the-maintainer-s-time-boxed-delegation-2026-09-03.md:15`). The
...
([`RFC-756`](../rfcs/RFC-00756-duplicated-status-in-claude-md-goes-stale.md)). **Read §1–§5 above; they are
the terms.**
...
[`../plans/PL-01038-w37-6-handover-at-the-close-of-the-delegated-window-2026-09-03.md`](../plans/PL-01038-w37-6-handover-at-the-close-of-the-delegated-window-2026-09-03.md)): whether
...
**The disclosure travels with it, and the four figures are not quotable apart.** RL-1040 §4
binds them together:
...
go-ahead. *It reverses RL-1039 in effect, since the exemption is what empties the
...
- `docs/w37-6-go-ahead-reask` carried #650's superseded document, preserved because
  [`../plans/PL-01031-w37-6-the-migration-run-the-go-ahead-re-ask.md`](../plans/PL-01031-w37-6-the-migration-run-the-go-ahead-re-ask.md) (PR #659)
...
[`../plans/PL-01034-w37-6-handover-at-the-halt-of-the-renewed-delegated-window-2026-09-03.md`](../plans/PL-01034-w37-6-handover-at-the-halt-of-the-renewed-delegated-window-2026-09-03.md),
merged as PR #673.

**All six gate conditions were met** and RFC-937 §7(a)'s bar was met — `none` = 0. **The run
...
copies goes stale ([`RFC-756`](../rfcs/RFC-00756-duplicated-status-in-claude-md-goes-stale.md)). **Read them
...
> *"The second fail was a fix that could not complete under RL-1041 §2.4 as drafted; the
...
satisfied.** RL-1042, filed as §2.5 of the RL-1041 record, replaces §2.4 by routing
...
([`RFC-756`](../rfcs/RFC-00756-duplicated-status-in-claude-md-goes-stale.md)). **Read them above.**
...
- **RFC-937 §7's own preamble**: *"**At the migration PR's merge tree:** (a) … (k)"*
  ([`docs/rfcs/RFC-00937-one-id-per-governed-thing-one-sequence-integer-identity-a-self-describing-layout-and-roles-per-family.md`](../rfcs/RFC-00937-one-id-per-governed-thing-one-sequence-integer-identity-a-self-describing-layout-and-roles-per-family.md) §7).
...
defect itself** — the thing RL-980 called *"worse than one that fails loudly"* — and a gate
...
`git ls-files docs/ | wc -l` = 465. **Before** PR #679 merged, it predicted that RL-1047's
