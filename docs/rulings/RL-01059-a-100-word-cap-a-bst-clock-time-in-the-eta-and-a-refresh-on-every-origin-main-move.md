...
id: RL-1059
family: ruling
title: a 100-word cap, a BST clock time in the ETA, and a refresh on every `origin/main` move
...
was: docs/plans/2026-09-04-ruling-106-slack-routine-word-cap-bst-eta-and-head-refresh.md
---

# W37-6 — RL-1059: the Slack routine (2026-09-04)

## RL-1059 — a 100-word cap, a BST clock time in the ETA, and a refresh on every `origin/main` move
...
git grep -ohE '^## Ruling [0-9]+' origin/main -- docs/ | grep -oE '[0-9]+' | sort -n | tail -1
  → 105
git grep -c 'RL-1059' $(git branch -r | grep -v HEAD) -- docs/ .claude/ scripts/
