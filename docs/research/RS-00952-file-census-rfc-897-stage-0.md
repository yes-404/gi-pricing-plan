...
family: research
kind: measurement
title: File census — RFC-897 Stage 0
status: active                  # draft → active → closed | retired (§1.2a)
created: 2026-09-01
owner: executor
corrected_by: []
relates: []                     # ids only — the FR-/ADR-/RFC- target a spike's `closed` cites
was: docs/audit/file-census.md
---

# File census — RFC-897 Stage 0

`docs/plans/PL-00929-rfc-897-file-taxonomy-reference-coding-and-custody-research-and-the-slice-cut.md` §7 (Slice 2). This is the evidence RFC-897's
...
`docs/research/file-census-5ef559d.csv` — **1319 data rows**, one per tracked file, header
...
checkable commit — the same citation style `docs/plans/PL-00929-rfc-897-file-taxonomy-reference-coding-and-custody-research-and-the-slice-cut.md`
...
docs/research/file-census-5ef559d.csv` returns 0, and likewise for
...
diff /tmp/c.csv docs/research/file-census-5ef559d.csv
...
(`docs/plans/PL-00929-rfc-897-file-taxonomy-reference-coding-and-custody-research-and-the-slice-cut.md` §7 Step 5), and covered by
