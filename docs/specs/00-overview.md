...
| **OQ-OVR-18** | `audit-docs.py` check 32's citation-resolution branch will fail the id standard's own specimen ids (`PL-1240`, `PL-01240`, `PL-001240` in NT-0019 §1.1 rule 3) as unresolvable citations once `docs/INDEX.md` exists; Ruling 103 §1.2's resolve-first rule fixes the sibling padding branch and cannot fix this one. Raised 2026-09-03 out of Ruling 103 §1.7. Mirrored in `docs/open-questions.md`. Status: **open**. |
