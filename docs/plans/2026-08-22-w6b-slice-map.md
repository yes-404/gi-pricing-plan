...
| The slice boundaries and sequencing in §3 | *pending* |
| The specification backlog in §4, as the gate on the blocked slices | *pending* |
| `W18` owns `FR-GOV-16`; roadmap line 1871 corrected with a dated note | *pending* |
| §5's two closure hazards, and who owns each | *pending* |
