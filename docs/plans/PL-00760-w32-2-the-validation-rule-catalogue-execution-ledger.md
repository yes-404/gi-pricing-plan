...
family: plan
kind: leaf
title: W32-2 — the validation rule catalogue: execution ledger
...
corrected_by: []
relates: []                     # ids only
was: docs/plans/2026-08-23-w32-2-validation-rule-catalogue-ledger.md
---

# W32-2 — the validation rule catalogue: execution ledger

What executing
[`PL-00761-w32-2-the-built-in-validation-rule-catalogue-implementation-plan.md`](PL-00761-w32-2-the-built-in-validation-rule-catalogue-implementation-plan.md)
...
| `FR-68` | unallocated | defined, routed, evidenced |
...
declared scope leaves `FR-67`, `NFR-465` and `NFR-466` untouched therefore cannot
...
- `FR-67`, `NFR-465` and `NFR-466` remain unevidenced, out of this slice's scope
