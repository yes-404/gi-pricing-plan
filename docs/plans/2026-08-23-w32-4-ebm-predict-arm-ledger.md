...
What executing [`2026-08-23-w32-4-ebm-predict-arm.md`](2026-08-23-w32-4-ebm-predict-arm.md)
...
widened: `FR-MODEL-124` was appended to carry it.

The third was not in the plan at all. `FR-MODEL-87`'s exhaustiveness guard tripped on the new
...
other two correctly attribute the frontend EBM views to W6b and were left alone.
