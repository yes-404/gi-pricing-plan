...
family: plan
kind: leaf
title: W37-6 gate condition 6 — the migration commit is proven revertible, 2026-09-03
...
corrected_by: []
relates: []                     # ids only
was: docs/plans/2026-09-03-w37-6-migration-revert-proof.md
---
...
the delegation §2, and the WK-697 Work close remains the maintainer's.
