...
the four that makes Ruling 95 pass as measured."* Run end to end, check-37 ruling failures go
**95 → 95**.
...
From [`…-second-withholding-and-standing-rules.md`](2026-09-02-w37-6-second-withholding-and-standing-rules.md)
...
`docs/audit/findings/F90.md` — F90's amendment is PR #656's and is unmerged at `796cd07`, which
