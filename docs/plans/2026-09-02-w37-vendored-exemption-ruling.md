...
[`2026-09-02-w37-5c-slice-decision.md`](2026-09-02-w37-5c-slice-decision.md) still describes the
...
> and filed as a register finding so the 63 unstamped files have custody (`NT-0005`), not just a
...
**Custody rather than an allowlist.** `NT-0005` — a deferred item with no owner is not deferred,
...
ruling permitting it, and **the exempt set is itself checked**. The second inherits Ruling 83's
...
`docs/process/delivery-process.core.json` and `docs/audit/file-census-5ef559d.csv`. **Condition 2
