# NT-0012 / NT-0013 / NT-0014 adoption — plan, delegation and rulings
...
1. **Scope** — *"after slice 2 ends, start adoption of NT0012 NT0013 and NT0014"*, following
   *"stop when slice 2 ends, file all the handover files, and do cleanup"*. W11 is **stopped,
...
- It covers **the landing of NT-0012, NT-0013 and NT-0014**, and nothing else.
- It does **not** extend to W11's close, W12, or any later phase. Those remain the
  maintainer's, and W11 in particular is stopped with its §13 audit unrun.
- It does **not** convert the lead into the maintainer for other purposes. Precedent for a
  bounded delegation of this kind is the **M2 delegation** cited in Ruling 29.
...
| **C** | NT-0012's two rules given durable homes | **this record's Ruling A1/A2** |
| **D** | NT-0013's "remove the relay" | **this record's Ruling A3** |
| **E** | Runtime state file (NT-0014 artifact B) + watcher | not started |
| **F** | Plan validator C1 + the acceptance-standard field in `writing-plans` | not started |
| **G** | Hooks C2 and C3 | not started — **blocked on NT-0014 Q2** |
...
entirely and means **NT-0014's open question Q2 — where hook registration lives — never has to
...
### Ruling A1 — NT-0012's credential-lifetime rule lands in `.claude/skills/secret-hygiene`

NT-0012 left this open, offering *"whichever role's charter owns posting to an external
...
### Ruling A2 — NT-0012's search-by-shape rule lands in `.claude/skills/close-workstream`
...
evidence. NT-0012's rule is the same failure one step earlier — searching for the *container's
...
### Ruling A3 — NT-0013's "remove the relay" lands in `delivery-process.md` §15
...
which is precisely the conclusion NT-0013's eight instances refute — the lead was reading
carefully each time.
...
The §14 plan review at W11's close **did not run** — the run stopped before the close. It was
...
NT-0014's C4 is a mechanism of exactly that family. So:
