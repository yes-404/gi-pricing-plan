...
family: plan
kind: leaf
title: W32-3 — dataset list derived fields: execution ledger
...
corrected_by: []
relates: []                     # ids only
was: docs/plans/2026-08-23-w32-3-dataset-list-derived-fields-ledger.md
---

# W32-3 — dataset list derived fields: execution ledger

What executing
[`PL-00763-w32-3-the-dataset-list-s-derived-fields-and-dataset-ownership-implementation-plan.md`](PL-00763-w32-3-the-dataset-list-s-derived-fields-and-dataset-ownership-implementation-plan.md)
...
| `FR-55`, `FR-82` | unevidenced | evidenced |
...
`FR-55` named fewer derived fields than the list view actually needs. Three landed,
...
| Gate `PATCH` on `dataset:write` | Would have refused `FR-82`'s own Admin arm — `admin` holds no write permission in this model. Gated on `dataset:read` instead |
...
The divergence is now caught rather than remembered: FR-417 and its guard test landed
