...
[`2026-09-02-w37-5c-slice-decision.md`](2026-09-02-w37-5c-slice-decision.md) with the two points
...
belongs to"*, and for both the answer is yes. **Neither is open work.** In particular: **Ruling 66
governs W37-6 — through §3.4's enlargement — but that is its live, sound obligation, not its
withdrawn acceptance item.** Ruling 73 replaced item 2 with a three-limb test whose falsifiability
was demonstrated against the real corpus in Ruling 73's own §5, and that replacement is what the
superseding leaf plan's Acceptance Standard item 11 now carries. **There is no open Ruling 66
...
§5.1, Addendum A, the roadmap's W37 row and the W37-5c slice decision. The finding was right and
