...
family: plan
kind: leaf
title: The README `owner:` row — a derivation for ruling
...
corrected_by: []
relates: []                     # ids only
was: docs/plans/2026-09-02-w37-readme-owner-derivation.md
---
...
| Class | Count | §5.2 row |
|---|---|---|
| `audit/work/*/README.md` and `closures/CR-00822-phase-record-1b-modelling-workbench.md` → `CR-`, `kind: work` / `phase` | **17** | *"`audit/work/*/README.md` (15), `closures/CR-00822-phase-record-1b-modelling-workbench.md`, `closures/CR-00821-phase-1b-exit-demo-uat-acceptance-record.md` → `closures/CR-0nnnn-*.md`"* |
| `findings/README.md` → deleted | **1** | *"deleted; content to `findings/` and `closures/` READMEs"* |
| `.claude/rfcs/README.md` → deleted with the stubs | **1** | *"`notes/*.md` (19 stubs) + README → deleted; `REDIRECTS.csv` rows"* |
...
**The fourteen:** `docs/README.md`, `docs/adrs/README.md`, `docs/audit/findings/README.md`,
`docs/contracts/README.md`, `docs/rfcs/README.md`, `docs/plans/README.md`,
...
|---|---|---|---|
| `docs/adrs/README.md` | ADRs | `ADR` — *"decision-maker, via `adr-write`"* | `decision-maker` |
| `docs/workflows/README.md` | workflows | `WF` — *"decision-maker, via `spec-change`"* | `decision-maker` |
| `docs/rfcs/README.md` | notes → the `RFC` family | `RFC` — *"maintainer mints and owns"* | `maintainer` |
