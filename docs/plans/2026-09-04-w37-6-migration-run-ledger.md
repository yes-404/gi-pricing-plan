...
| #727 | fix(scripts): name three more (g) residue shapes — the third `other`-triage scope | `046576c` | Not independently re-run — CI is the merge gate, all green, CLEAN. `--verify` re-run post-rebase: UNCHANGED: 14, matching the recorded set. |
