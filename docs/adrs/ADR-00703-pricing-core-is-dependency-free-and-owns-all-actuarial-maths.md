...
id: ADR-703
family: decision
title: pricing-core is dependency-free and owns all actuarial maths
...
was: docs/adr/0001-pricing-core-is-dependency-free.md
---

# pricing-core is dependency-free and owns all actuarial maths
...
- Stochastic functions take an explicit `seed: int` (FR-11).
...
fixtures; publication of `pricing-core` to PyPI from Phase 2 as `0.x` (OQ-545, decided 2026-08-14; an editable install serves Phase 1); a clean seam for
