...
| **Credibility theory** | 02 FR-MODEL-14, OQ-MODEL-5 | ★★ | Limited fluctuation (full/partial credibility standards) vs Bühlmann–Straub variance components; what a UK reviewer expects to see in a grouping justification. **Built 2026-08-15 (W5): limited fluctuation only** — `buhlmann_straub` is refused by name while OQ-MODEL-5 is open, and the standard that ran is recorded per grouping | Klugman, Panjer & Willmot, *Loss Models*; CAS credibility study notes |
