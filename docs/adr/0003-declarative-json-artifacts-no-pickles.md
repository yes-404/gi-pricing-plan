# ADR-0003 — Model and rating definitions are declarative JSON artifacts

- **Status:** accepted
- **Date:** 2026-08-14
- **Deciders:** maintainer
- **Related:** FR-OVR-1, FR-OVR-2, ADR-0002, ADR-0004
...
- **Rating algorithm** — a JSON DAG (ADR-0004) plus JSON/parquet rate tables.
...
**Positive** — artifacts are diffable in review, portable between instances (FR-OVR-2),
