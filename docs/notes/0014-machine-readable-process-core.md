...
| **Status** | `landed` 2026-08-31 — **all eight slices merged**: A `33b5ef1`, B `0be9c3c` (check 26), C+D `97965be`, E `b551060` (artifact B), F `26de823` (check 28), H `53257b4` (check 27), G `9e8783d` (C2). **C3 dissolved by Ruling 40, not built.** Closed at `docs/audit/work/nt-0012-0013-0014-adoption/README.md`; open findings carried there as F57, F58 and F61. **Corrected from `accepted`**, which was right this morning while E/F/G were outstanding and stopped being right when G merged |
...
**A note decides nothing** (`docs/notes/README.md`). This one records a proposal, the
