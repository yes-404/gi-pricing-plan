# NT-0001 — Plan review at each phase boundary
...
| **Trigger** | Each workstream close, and again before a phase's exit demo |
...
2. **Omission.** What the phase plainly needs that no workstream row names. W4's Dagster
