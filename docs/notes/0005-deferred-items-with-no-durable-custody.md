...
[`docs/notes/README.md`](README.md) makes about a silently-passing check.
...
[`docs/notes/README.md`](README.md)'s standard so they are not lost between sessions. The
