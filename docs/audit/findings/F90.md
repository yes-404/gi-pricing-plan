...
The measurement above is taken at `4df1c45`, which the W37 roadmap row records as reachable
...
The option list says option 4 is *"the only option of the four that makes Ruling 95 pass as
