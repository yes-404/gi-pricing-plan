...
which is what W37-6 does, and what NT-0019 §1.11 check 30 describes as *"every file under `docs/`,
...
`docs/audit/file-census-5ef559d.csv` — are reached by nothing.**
...
Per [`NT-0005`](../../notes/0005-deferred-items-with-no-durable-custody.md), a deferred item with
