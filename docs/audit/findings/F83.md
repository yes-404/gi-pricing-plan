...
claim cell and disposition in `docs/audit/register.md` carry the same figure and the same
...
| `docs/audit/file-census-5ef559d.csv` | CSV has no comment syntax either |
