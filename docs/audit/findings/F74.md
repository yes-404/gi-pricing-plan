...
Evidence essay for the register row self-named `(F74)` in `docs/audit/register.md`. The
...
`docs/notes/0019-one-id-per-document.md` — status `accepted`, raised 2026-09-01 by the
...
of which reading of NT-0019 §1.6 governs right now. Whether the correction is the lead's to
make under `CLAUDE.md` §12's standing practice, or waits for the maintainer under NT-0019
...
- **Proposed disposition** (a proposal; the verdict is the lead's): carry forward, unowned.
  ...
  session it is found (`CLAUDE.md` §12), or the maintainer, under NT-0019 §1.6's accepted-
