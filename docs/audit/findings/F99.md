...
goes stale exactly as [`NT-0003`](../../notes/0003-duplicated-status-goes-stale.md) describes, with
...
**Id allocation.** `git grep -hoE '\bF[0-9]{2,3}\b' origin/main -- docs/audit/register.md
