...
be the **first** word after the heading marker. A file titled, say, `# W37-6 — Ruling 98:
...` does not match this either: "Ruling" is not the first word. The census's own docstring
independently anticipates part of this class — *"Ruling 87: a standalone ruling file (the h1
...
introduce this finding**: `docs/plans/2026-09-03-w37-6-ruling-98-prose-migration.md` (Ruling
98, merged `d1cabe1`) and `docs/plans/2026-09-03-w37-6-ruling-99-three-undeclared-files.md`
(Ruling 99). Both were verified, not assumed, by running `_discover_multi_ruling_files` and
...
draft (`owner: decision-maker`, the correct default per Ruling 95) and zero `PL-` drafts
after.

**One pre-existing instance, unrelated to this window's own filings, found while measuring
the above and not yet fixed**: `docs/plans/2026-09-02-w37-vendored-exemption-ruling.md`
...
keys on — and the file this finding's own author had freshly re-read every clause of NT-0019
...
claimed, just claimed wrong. This is the same asymmetry `NT-0007` records and F84 already
