...
- **PR count, corrected once already in drafting this record and re-checked here**: the
  ...
  **22** — `#593` through `#614`, every number present (an earlier pass of this record
  stopped enumerating at `#613`, undercounting by exactly the PR carrying Ruling 94 itself;
  ...
  as a disclosure outside the slice; `09b7e9b` (#614, Ruling 94) is a pure ruling record with
...
- F77 [Ruling 84 §4's second acceptance item... is vacuously true and untestable as stated] —
  carry forward, unowned — the interpretation question is Ruled 2026-09-02 (Ruling 94, PR
...
- F81 [`migrate()` also halts on the real Ruling A1/A2/A3 file...] — not started — discovery
...
`docs/audit/register.md` itself.) **Reconciliation, per §5b's own requirement**: every id in
