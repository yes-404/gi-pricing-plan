...
| **W11** | Scoring: real-time, batch, trace, one shared evaluator | FR-RATE-34..42, FR-RATE-64 (added 2026-08-18 with OQ-RATE-6 — the row's original "FR-RATE-34..42" omitted it); NFR-RATE-1 is the hard target |
