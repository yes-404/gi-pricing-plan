...
| [NT-0005](0005-deferred-items-with-no-durable-custody.md) | Six deferred items with no durable custody — found during W6b, held only in a session's working memory | 2026-08-24 | `open` | Mixed, per item: a marker line, a roadmap row, two one-line `audit-docs.py` fixes, a convention, a new check, and one `OQ-` entry |
