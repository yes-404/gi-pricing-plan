...
| [NT-0005](0005-deferred-items-with-no-durable-custody.md) | Seven deferred items with no durable custody — found during W6b, held only in a session's working memory | 2026-08-24 | `open` | Mixed, per item; **moves to the post-W7 restructure project** — the closure-audit register is the custody home |
