...
| **Status** | `open` — assessed here, not agreed. Six items below need a maintainer ruling before any of it is built |
...
Nothing. Per `.claude/notes/README.md`, a note is raw material. The four-layer hierarchy,
