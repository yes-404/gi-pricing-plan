...
| [`docs-audit`](docs-audit/SKILL.md) | Verify suite integrity before a commit or PR — 15 checks (8 bookkeeping, 7 structural) plus the decision-gate invariant the script does not cover | self-written | 2026-08-14 |
