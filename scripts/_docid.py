...
# "WK-661-WF-01") is refused by the second branch exactly as before, since its own two
...
def resolve_to_control_paths(
    ...
    **Never resolved by first-match.** If two migrated files sharing one control path
    ...
    example: `docs/findings/register.md` <- both `docs/findings/register.md` and
    `docs/findings/register.md`) is the opposite shape, and there is no slug that
